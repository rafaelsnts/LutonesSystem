...
namespace LutonesSystem.XPO.LutonesSystem
{
    public static class ConnectionHelper
    {
        static Type[] persistentTypes = new Type[] {
            typeof(tb_clientesXPO),
            typeof(tb_fornecedoresXPO),
            typeof(tb_funcionariosXPO),
            typeof(tb_insumosXPO),
            typeof(tb_produtosXPO)
        };
        ...
        public static string ConnectionString { get { return System.Configuration.ConfigurationManager.ConnectionStrings["RAFAELSQLEXPRESSLutonesSystem"].ConnectionString; } }
